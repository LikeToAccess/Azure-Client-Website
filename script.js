...
document.getElementById("suggestion_link_id").onclick = function() {
	...
	if (suggestion != '') {
    	...
    	//ok
		alert('Suggestion submited. Your device ID has been logged. This is only to prevent potential spam. In the event of a spammer, they will be blocked from using Azure Client');
